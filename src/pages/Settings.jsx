          ...
          <div className="settings-grid">
            ...
            <div className="card setting-card">
              <div className="setting-item">
                ...
                <button onClick={toggleTheme} className="toggle-button" aria-label="Dark Mode umschalten">
                  <div className={`toggle-switch ${document.body.classList.contains('dark-mode') ? 'active' : ''}`}>
